...
//   console.log(disabled);
  ...
  if (sum >= 21) {
    return <GameResult player1={data?.player1} />;
  }
  if (sum2 >= 21) {
    return <GameResult player2={data?.player2} />;
  }
  ...
  return (
    <div className="game-container">
      <img src="./logo1.png" alt="BitApps" className="game-logo " />{" "}
      {/* <img src='./dices-removebg-preview.png' alt='BitApps' class="game-logo "/> */}
      <br />
